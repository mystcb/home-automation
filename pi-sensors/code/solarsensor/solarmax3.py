...
status_codes = {
      ...
      20001: 'Active',
      20002: 'Too little irradiation',
      20003: 'Hit',
      20004: 'Operation on MPP',
      20005: 'Fan running',
      20006: 'Operation at maximum power',
      20007: 'Temperature limitation',
      20008: 'Feeding into the grid',
    }
...
alarm_codes = {
          0: 'No Alarm',
          1: 'External Error 1',
          2: 'Isolation fault - DC side',
          4: 'Residual current earth too large',
          8: 'Central fuse break?',
         16: 'External Alarm 2',
         32: 'Overheat limitation',
         64: 'AC Supply Issue',
        128: 'External Alarm 4',
        256: 'Fan Fault',
        512: 'Blown Fuse',
       1024: 'Temperature Sensor Failure',
       2048: 'Alarm 12',
       4096: 'Alarm 13',
       8192: 'Alarm 14',
      16384: 'Alarm 15',
...
class SolarMax ( object ):
  ...
  def __send_query(self, querystring):
    try:
      ...
      DEBUG("Error sending query: {}".format(str(e)))
  ...
  def normalize_value(self, key, value):
    try:
        ...
        DEBUG("Error normalizing value {} ({}): {}".format(key,value,str(e)))
  ...
  def status(self, inverter):
    ...
    if result['SAL'] > 0:
      ...
      errors=["No further information available"]
